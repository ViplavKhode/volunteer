...
@Slf4j
public class UpdateVolunteerCompletionHandler extends BaseRequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent requestEvent, Context lambdaContext) {
        try {
            ...
            VolunteerResponse created = volunteerService.updateVolunteerCompletion(createRequest);
