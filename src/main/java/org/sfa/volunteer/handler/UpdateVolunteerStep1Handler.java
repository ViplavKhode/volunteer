...
@Slf4j
public class UpdateVolunteerStep1Handler extends BaseRequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent requestEvent, Context lambdaContext) {
        ...
        try {
            ...
            VolunteerResponse updatedVolunteer = volunteerService.updateVolunteerStep1(updateRequest);
